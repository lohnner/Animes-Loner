...
const PROGRESS_FIELDS = {
  ...
  youjoSenki: 'youjoSenkiWatchedEpisodes', youjoSenkiMovie: 'youjoSenkiMovieWatchedEpisodes',
  youjoSenkiSeason2: 'youjoSenkiSeason2WatchedEpisodes',
...
const WATCH_OPTIONS = {
  ...
  bleach: { title: 'Bleach', platform: 'Disney+', url: 'https://www.disneyplus.com/pt-br/search?q=Bleach' },
  bleachTybbw: { title: 'Bleach: Thousand-Year Blood War', platform: 'Disney+', url: 'https://www.disneyplus.com/pt-br/browse/entity-571475d5-8b1a-453f-a57f-26bb4dd13304' },
  ...
  youjoSenki: { title: 'Youjo Senki: Saga of Tanya the Evil', platform: 'Crunchyroll', url: 'https://www.crunchyroll.com/pt-br/series/GR9P57W96/saga-of-tanya-the-evil' },
  youjoSenkiMovie: { title: 'Youjo Senki: O Filme', platform: 'Crunchyroll', url: 'https://www.crunchyroll.com/pt-br/series/GR9P57W96/saga-of-tanya-the-evil' },
  youjoSenkiSeason2: { title: 'Youjo Senki II', platform: 'Crunchyroll', url: 'https://www.crunchyroll.com/pt-br/series/GR9P57W96/saga-of-tanya-the-evil' },
  ...
  elusiveSamurai: { title: 'The Elusive Samurai', platform: 'Crunchyroll', url: 'https://www.crunchyroll.com/pt-br/series/GQWH0M19X/the-elusive-samurai' },
  elusiveSamuraiSeason2: { title: 'The Elusive Samurai: 2ª Temporada', platform: 'Crunchyroll', url: 'https://www.crunchyroll.com/pt-br/series/GQWH0M19X/the-elusive-samurai' }
};
...
const ELUSIVE_SAMURAI_SEQUENCE = [
  { key:'elusiveSamurai', title:'The Elusive Samurai', subtitle:'1ª temporada', href:'the-elusive-samurai.html', cover:'the-elusive-samurai-500x750.jpg', episodes:12, year:2024, status:'Completo', description:'Em 1333, o jovem herdeiro Hojo Tokiyuki sobrevive à queda do xogunato Kamakura e foge com o sacerdote Suwa Yorishige, reunindo aliados para recuperar seu lugar na história.' },
  { key:'elusiveSamuraiSeason2', title:'The Elusive Samurai: 2ª Temporada', subtitle:'2ª temporada', href:'the-elusive-samurai-season-2.html', cover:'the-elusive-samurai-season-2-500x750.jpg', episodes:12, year:2026, status:'Em lançamento', description:'Tokiyuki e seus companheiros continuam sua campanha para sobreviver ao novo regime, fortalecer suas alianças e preparar o caminho de volta a Kamakura.' }
];
...
const BLEACH_SEQUENCE = [
  { key:'bleach', title:'Bleach', subtitle:'Série clássica', href:'bleach.html', cover:'bleach-hd.jpg', episodes:366, year:2004, status:'Completo', description:'Ichigo Kurosaki recebe os poderes de uma Shinigami e passa a proteger os vivos dos Hollows enquanto descobre os conflitos da Soul Society.' },
  { key:'bleachTybbw', title:'Bleach: Thousand-Year Blood War', subtitle:'Guerra Sangrenta • Parte 1', href:'bleach-thousand-year-blood-war.html', cover:'bleach-tybw-hd.jpg', episodes:13, year:2022, status:'Completo', description:'O império Quincy declara guerra à Soul Society, forçando Ichigo e os capitães a enfrentar a maior ameaça de sua história.' },
  { key:'bleachTybbwSeparation', title:'Bleach: A Separação', subtitle:'Guerra Sangrenta • Parte 2', href:'bleach-tybw-separation.html', cover:'bleach-tybw-separation-hd.jpg', episodes:13, year:2023, status:'Completo', description:'Com o retorno do Wandenreich, Ichigo conclui seu treinamento enquanto Uryu toma uma decisão que o coloca ao lado de Yhwach.' },
...
const YOUJO_SENKI_SEQUENCE = [
  { key:'youjoSenki', title:'Youjo Senki', subtitle:'1ª temporada', href:'youjo-senki.html', cover:'youjo-senki-hd.jpg', episodes:12, year:2017, status:'Completo', description:'Após desafiar uma entidade divina, um assalariado é reencarnado como Tanya Degurechaff e usa sua inteligência e magia para sobreviver nas linhas de frente de uma guerra brutal.' },
  { key:'youjoSenkiMovie', title:'Youjo Senki: O Filme', subtitle:'Continuação em filme', href:'youjo-senki-movie.html', cover:'youjo-senki-movie-hd.jpg', episodes:1, year:2019, status:'Filme', description:'Tanya e o 203º Batalhão de Magos retornam ao campo de batalha e enfrentam uma nova ameaça movida por vingança no conflito contra a Federação Russy.' },
  { key:'youjoSenkiSeason2', title:'Youjo Senki II', subtitle:'2ª temporada', href:'youjo-senki-season-2.html', cover:'youjo-senki-season-2-hd.webp', episodes:12, year:2026, status:'Em exibição', description:'Promovida a comandante do recém-formado Grupo de Combate Salamandra, Tanya volta a encarar uma guerra sem saída e o rigoroso inverno da Federação.' }
];
...
const youjoSenkiWatched = (profile = {}) => sequenceWatched(profile, YOUJO_SENKI_SEQUENCE);
...
function renderProgress() {
  ...
  const progressCta = document.querySelector('.anime-detail-inner a.button.primary[href^="#"]');
  if (progressCta) progressCta.textContent = watched > 0 ? 'Continuar Assistindo' : 'Começar a Assistir';
...
function renderVillagerCatalogCard() {
  ...
  const extraAnimes = [
    ...
    ,{ search:'youjo senki saga of tanya the evil tanya degurechaff', href:'youjo-senki.html', cover:'youjo-senki-hd.jpg', title:'Youjo Senki', tag:'ISEKAI MILITAR', episodesLabel:'3 etapas • 24 episódios • 1 filme' }
  ];
  ...
  try {
    ...
    if (document.body.dataset.ranking === 'animes') {
      const animeRanking = [
        ...
        ,{ title:'Youjo Senki', href:'youjo-senki.html', cover:'youjo-senki-hd.jpg', points:users.filter(u=>youjoSenkiWatched(u)>=1).length, total:25 }
...
function profileAnimeCards(profile = {}) {
  const animes = [
    ...
    ,{title:'Youjo Senki',href:'youjo-senki.html',cover:'youjo-senki-hd.jpg',watched:youjoSenkiWatched(profile),total:25}
